...
# summere og plot af udbytte i tørstof DM       
        ...
        SB.pea = DMG.get_group('Pea').sum(axis=1)
# Laver et subplot, som derefter bliver det aktive som de næste plt virker på
        ax=plt.subplot(3,4,index)
        index+=1
        df22= pd.DataFrame([sb, lupin, majs, SB.pea]).T
        df22.columns =['SB', 'Aert', 'Majs', 'SB.pea']
...
#Group og tag gennemsnit
        ...
        plt.tight_layout()
fig.savefig("Ryegrass_DM_jj.pdf", bbox_inches='tight')       
