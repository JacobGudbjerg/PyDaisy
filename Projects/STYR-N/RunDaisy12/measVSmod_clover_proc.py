...
# Laver et subplot, som derefter bliver det aktive som de næste plt virker på
        ...
        ms=df2.join(meas) 
#        ms['pct_clover']=ms['cloverDM']/(ms['cloverDM']+ms['grassDM'])*100
        plt.scatter(ms['pct_clo'], ms['sim-pct_clov'], marker='x', c='black', s=15)
        plt.title(d+'-Clover_pct', position = (0.5, 0.01), fontweight="bold", fontsize=8)
        ...
        plt.text(1,4, eva)
        plt.tight_layout()
fig.savefig("Cloverprocent_jj.pdf", bbox_inches='tight')
